 ...
 * Returns 'F' if below passing marks.
 */
...
/**
 * POST /api/results/enter — faculty
 * Body: { exam, entries: [{ student, marksObtained, remarks? }], remarks? }
 */
...
/**
 * GET /api/results — admin/faculty
 * Query: student, exam, course
 */
...
/**
 * GET /api/results/my — logged-in student
 * Returns both individual exam results AND batch-uploaded results.
 */
const getStudentResults = async (req, res) => {
  try {
    ...
    // 1. Fetch individual exam results (published only)
...
/**
 * POST /api/results/publish/:examId — admin or faculty
 * Marks all results for an exam as published.
 */
...
/**
 * GET /api/results/analysis/:examId — admin or faculty
 */
